...
class Trade extends EventEmitter {
    ...
    toJSON() {
        ...
        _.extend(obj, {
            ...
            executedBaseQuantity: executedBaseQuantity instanceof BigNumber ? executedBaseQuantity.toJSON() : executedBaseQuantity,
            executedQuantity: executedQuantity instanceof BigNumber ? executedQuantity.toJSON() : executedQuantity,
            executedMeanRate: executedMeanRate instanceof BigNumber ? executedMeanRate.toJSON() : executedMeanRate
        });
